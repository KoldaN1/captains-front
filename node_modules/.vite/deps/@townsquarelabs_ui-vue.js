...
var require_nacl_fast = __commonJS({
  "node_modules/tweetnacl/nacl-fast.js"(exports, module) {
    (function(nacl2) {
      ...
      function crypto_onetimeauth_verify(h3, hpos, m, mpos, n2, k) {
      ...
      function crypto_hashblocks_hl(hh, hl, m, n2) {
        var wh = new Int32Array(16), wl = new Int32Array(16), bh0, bh1, bh2, bh3, bh4, bh5, bh6, bh7, bl0, bl1, bl2, bl3, bl4, bl5, bl6, bl7, th, tl, i2, j, h3, l2, a2, b, c2, d;
      ...
      function add(p2, q) {
        var a2 = gf(), b = gf(), c2 = gf(), d = gf(), e2 = gf(), f = gf(), g = gf(), h3 = gf(), t2 = gf();
        Z(a2, p2[1], p2[0]);
        Z(t2, q[1], q[0]);
        M(a2, a2, t2);
        A(b, p2[0], p2[1]);
      ...
      function crypto_sign(sm, m, n2, sk) {
        var d = new Uint8Array(64), h3 = new Uint8Array(64), r = new Uint8Array(64);
...
// node_modules/@townsquarelabs/ui-vue/node_modules/@tonconnect/sdk/lib/esm/index.mjs
...
// node_modules/@townsquarelabs/ui-vue/node_modules/@tonconnect/ui/lib/index.mjs
...
function assignProp(node, prop, value, prev, isSVG, skipRef) {
  ...
  if (prop === "ref") {
    ...
    if (!delegate && prev) {
      const h22 = Array.isArray(prev) ? prev[0] : prev;
      node.removeEventListener(name, h22);
    }
    if (delegate || value) {
...
var tonConnectUiVersion = "2.0.10-beta.0";
...
// node_modules/@townsquarelabs/ui-vue/lib/index.mjs
...
@tonconnect/ui/lib/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=@townsquarelabs_ui-vue.js.map
