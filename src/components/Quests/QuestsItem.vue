...
<template>
    <div class="flex relative rounded-2xl p-2.5 text-sm overflow-hidden" :class="background, textColor">
        <div class="flex w-full gap-x-2 items-center justify-between">
            ...
            <span v-if="!task.is_completed" class='flex text-xs font-medium gap-x-1 rounded-lg'>
                <span class="bg-bg_color text-black justify-center items-center h-9 w-20 rounded-full flex">{{ $t('quests') }}</span>
            </span>
